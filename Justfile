...
# Justfile for SoftwareSovereign.jl
...
doctor:
    @echo "Running diagnostics for SoftwareSovereign.jl..."
...
tour:
    @echo "=== SoftwareSovereign.jl Tour ==="
    @echo ""
...
help-me:
    @echo "=== SoftwareSovereign.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/SoftwareSovereign.jl/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: SoftwareSovereign.jl"
