= Softwaresovereign.Jl — User Quickstart
:toc: preamble
...
[source,bash]
----
git clone https://github.com/hyperpolymath/SoftwareSovereign.jl
cd SoftwareSovereign.jl
...
* https://github.com/hyperpolymath/SoftwareSovereign.jl/issues — report bugs
